...
import { FaHammer, FaCogs, FaHeart, FaRegThumbsUp } from "react-icons/fa";
import { FaMagnifyingGlass } from "react-icons/fa6";

const WhyUsSection = () => {
  return (
    <section className="max-w-7xl mx-auto py-16 h-auto">
      ...
      <div className="grid grid-rows-1 md:grid-rows-2 lg:grid-rows-3 gap-8 px-4">
        {/*  */}
        <div className="bg-[#23627C] p-8 rounded-lg shadow-lg sm:w-1/3 mx-auto sm:mr-auto md:ml-[14vw]">
          <h3 className="flex text-2xl font-bold text-white mb-4 justify-center">
        ...
        {/*  */}
        <div className="bg-[#23627C] p-8 rounded-lg shadow-lg sm:w-1/3 mx-auto sm:ml-auto md:mr-[14vw]">
          <h3 className="flex text-2xl font-bold text-white mb-4 justify-center">
